...
$cari = mysqli_query($conn, "SELECT nama_driver FROM tbdriver WHERE username = '$usr'");
$driver = mysqli_fetch_array($cari);
$driver = $driver[0];
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    <title>SISFOTRAVEL - Laporan Keberangkatan</title>
    <!--meta-->
    <meta charset="utf-8">
